...
print("UserA is assigned to: " + ch.get_server("UserA"))  # Maps UserA to a server
print("UserB is assigned to: " + ch.get_server("UserB"))  # Maps UserB to a server

# Step 3: Add a new server dynamically
ch.add_server("S6")
print("UserA is now assigned to: " + ch.get_server("UserA"))  # Might be reassigned if affected

# Step 4: Remove a server dynamically
ch.remove_server("S2")
print("UserB is now assigned to: " + ch.get_server("UserB"))  # Might be reassigned if affected